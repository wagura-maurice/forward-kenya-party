...
class Village extends Model
{
    ...
    {
        return \App\Http\Requests\API\VillageRequest::class;
    }

    protected function getResourceClass(): string
    {
        return \App\Http\Resources\API\VillageResource::class;
    }

    public static function createRules()
    {
        return [
            'uuid' => ['nullable', 'string', Rule::unique('villages', 'uuid')],
    ...
    {
        return [
            'uuid' => ['nullable', 'string', Rule::unique('villages', 'uuid')->ignore($id)],
