        ...
        $sharedData = [
            ...
            'auth' => [
                'user' => $request->user() ? [
                    ...
                    'profile' => $request->user()->profile ? $request->user()->profile->toArray() : null,
                    'member' => $request->user()->member ? $request->user()->member->load('ethnicity', 'religion', 'county', 'subCounty', 'constituency', 'ward', 'location', 'village', 'pollingCenter', 'pollingStation', 'pollingStream')->toArray() : null,
