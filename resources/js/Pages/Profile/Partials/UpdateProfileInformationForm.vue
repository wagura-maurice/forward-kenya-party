...
watch(
    ...
    (newCitizen) => {
        if (newCitizen && Object.keys(newCitizen).length > 0) {
            ...
            form.citizen.national_identification_number =
                newCitizen.national_identification_number || null;
            form.citizen.passport_number = newCitizen.passport_number || null;
            form.citizen.driver_license_number =
                newCitizen.driver_license_number || null;
            ...
            form.citizen.polling_center_id =
                newCitizen.polling_center_id || null;
            form.citizen.polling_station_id =
                newCitizen.polling_station_id || null;
            form.citizen.polling_stream_id =
                newCitizen.polling_stream_id || null;
                    ...
                    >
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <InputError
                                    :message="
                                        form.errors['profile.date_of_birth']
                                    "
                                    class="mt-2"
                                />
                            </div>
                    ...
                    >
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <InputError
                                    :message="
                                        form.errors['citizen.passport_number']
                                    "
                                    class="mt-2"
                                />
                            </div>
                    ...
                    >
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <InputError
                                    :message="
                                        form.errors['profile.address_line_1']
                                    "
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <InputError
                                    :message="
                                        form.errors['profile.address_line_2']
                                    "
                                    class="mt-2"
                                />
                            </div>
                    ...
                    >
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        <option
                                            v-if="
                                                citizen?.sub_county &&
                                                citizen.sub_county.county_id ==
                                                    form.citizen.county_id
                                            "
                                            :value="citizen.sub_county_id"
                                            :key="
                                                'current-subcounty-' +
                                                citizen.sub_county_id
                                            "
                                        >
                                ...
                                <InputError
                                    :message="
                                        form.errors['citizen.sub_county_id']
                                    "
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <InputError
                                    :message="
                                        form.errors['citizen.constituency_id']
                                    "
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <InputError
                                    :message="
                                        form.errors['citizen.location_id']
                                    "
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <InputError
                                    :message="
                                        form.errors['citizen.polling_center_id']
                                    "
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <InputError
                                    :message="
                                        form.errors['citizen.polling_stream_id']
                                    "
                                    class="mt-2"
                                />
                            </div>
            ...
            >
                ...
                <div class="mt-4 text-center">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <a
                            href="mailto:support@forwardkenyaparty.com"
