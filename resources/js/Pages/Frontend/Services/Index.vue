...
const navigateToServices = (updates = {}) => {
    ...
    router.get(route("frontend.services"), params, {
        preserveState: true,
        replace: false,
        preserveScroll: true,
        only: ["services", "filters", "currentSort", "currentSortLabel"],
        onFinish: () => {
...
watch(
    ...
    ([newSearch, newDept], [oldSearch, oldDept]) => {
        if (isNavigating.value) return;
...
<template>
    <GuestLayout :title="title" :menuLogo="logoUrl" :footerLogo="logoUrl">
        <section class="container mx-auto px-4 py-8 pt-36 flex-1">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select
                                ...
                                class="block w-full pl-3 pr-8 py-3 text-sm border border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 rounded-md dark:bg-gray-700 dark:border-gray-600 appearance-none"
                                :class="{
                                    'text-gray-400': !selectedDepartment,
            ...
            <!-- Services Grid -->
            <template v-if="services.data && services.data.length > 0">
                <div
                ...
                >
                    ...
                    <div class="flex items-center space-x-2">
                        <!-- Previous Button -->
                        <button
                            @click="handlePageClick(services.current_page - 1)"
            ...
            <div v-else class="text-center py-12">
                ...
                >
                    ...
                    <ul class="space-y-2">
                        ...
                        <li v-if="selectedDepartment" class="flex items-start">
                            <span
                                class="text-gray-500 dark:text-gray-400 w-32 flex-shrink-0"
                                >Department:</span
                            >
                ...
                <p class="mt-4 text-gray-500 dark:text-gray-400 mb-6">
                    ...
                    Try adjusting your search or reset the filters to see all
                    services.
                </p>
