        ...
        <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
            <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
                        ...
                        <div class="space-y-4">
                            ...
                            <dl>
                                ...
                                >
                                    ...
                                    2 Miles Drive, NJ 071, New York, United
                                    States of America
                                </dd>
                            </dl>
                            <dl>
                                ...
                                >
                                    ...
                                    9th St. PATH Station, New York, United
                                    States of America
                                </dd>
                            </dl>
                        </div>
                        <div class="space-y-4">
                            ...
                            <dl>
                                ...
                                >
                                    ...
                                    Herald Square, 2, New York, United States of
                                    America
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <dl>
                                ...
                                >
                                    ...
                                    <div>
                                        <div class="text-sm">
                                            <p
                                                class="mb-0.5 font-medium text-gray-900 dark:text-white"
                                            >
                                                Visa ending in 7658
                                            </p>
                                            <p
                ...
                >
                    ...
                    <div
                        class="flex flex-wrap items-center gap-y-4 pt-4 md:pt-5"
                    >
                        <dl class="w-1/2 sm:w-48">
                            <dt
                                class="text-base font-medium text-gray-500 dark:text-gray-400"
            ...
            >
                <div class="max-h-auto relative max-h-full w-full max-w-lg p-4">
                    <!-- Modal content -->
                    <div
                        class="relative rounded-lg bg-white shadow dark:bg-gray-800"
                    >
                        <!-- Modal header -->
                        <div
                        ...
                        <form class="p-4 md:p-5">
                            <div
                                class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2"
                            >
