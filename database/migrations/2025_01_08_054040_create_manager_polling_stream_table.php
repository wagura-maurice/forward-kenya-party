...
return new class extends Migration
{
    ...
    {
        Schema::create('manager_polling_stream', function (Blueprint $table) {
            // $table->id();
            $table->primary(['polling_stream_id', 'manager_id'])->comment('Composite primary key for the pivot table');
    ...
    {
        Schema::dropIfExists('manager_polling_stream');
    }
};
