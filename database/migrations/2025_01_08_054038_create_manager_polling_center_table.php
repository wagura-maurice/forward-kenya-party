...
return new class extends Migration
{
    ...
    {
        Schema::create('manager_polling_center', function (Blueprint $table) {
            // $table->id();
            $table->primary(['polling_center_id', 'manager_id'])->comment('Composite primary key for the pivot table');
    ...
    {
        Schema::dropIfExists('manager_polling_center');
    }
};
