...
return new class extends Migration
{
    ...
    {
        Schema::create('county_manager', function (Blueprint $table) {
            // $table->id();
            $table->primary(['manager_id', 'county_id'])->comment('Composite primary key for the pivot table');
    ...
    {
        Schema::dropIfExists('county_manager');
    }
};
