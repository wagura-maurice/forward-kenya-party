...
return new class extends Migration
{
    ...
    {
        Schema::create('administrator_county', function (Blueprint $table) {
            // $table->id();
            $table->primary(['county_id', 'administrator_id'])->comment('Composite primary key for the pivot table');
            ...
            $table->index('county_id')->comment('Index on county_id for faster lookup');
    ...
    {
        Schema::dropIfExists('administrator_counties');
    }
};
