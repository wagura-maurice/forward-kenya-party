...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('constituencies', function (Blueprint $table) {
            ...
            $table->text('description')->nullable()->comment('Description of the constituency');
            $table->json('configuration')->nullable()->comment('JSON configuration for the constituency metadata');
            $table->softDeletes();
            $table->timestamps();
        });        
    }
